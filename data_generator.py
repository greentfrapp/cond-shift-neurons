...
class OmniglotGenerator(object):
    ...
    def __init__(self, num_classes, num_samples_per_class, test=False):
...
class DataGenerator(object):
    ...
    """
    def __init__(self, datasource, num_classes, num_samples_per_class, batch_size, config={}, test_set=False):
        """
        Args:
        ...
        if self.datasource == 'sinusoid':
            ...
            self.metatrain_character_folders = character_folders[:num_train]
            # start = int(config.get('run', 0) * num_train)
            # end = int(start + num_train)
            # self.metatrain_character_folders = character_folders[start:end]
            if self.test_set:
                self.metaval_character_folders = character_folders[num_train+num_val:]
                # self.metaval_character_folders = character_folders[1200:]
            else:
                self.metaval_character_folders = character_folders[num_train:num_train+num_val]
                # self.metaval_character_folders = character_folders[1100:1200]
